...
-- Using publicly available animated emoji GIFs
INSERT INTO stickers (id, pack_id, name, image_url, is_animated, display_order, created_at, updated_at)
SELECT
  gen_random_uuid(),
  sp.id,
...
FROM sticker_packs sp
CROSS JOIN (VALUES
  ('https://media.giphy.com/media/l0MYC0Laj6Po8zF8s/giphy.gif', 'Thumbs Up GIF', 1),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Thumbs Down GIF', 2),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Clapping Hands GIF', 3),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Fire GIF', 4),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', '100 GIF', 5),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Applause GIF', 6),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Lit GIF', 7),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'No Way GIF', 8),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Yes GIF', 9),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Amazing GIF', 10),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Perfect GIF', 11),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Bravo GIF', 12),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Epic GIF', 13),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Mind Blown GIF', 14),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Wow GIF', 15),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Incredible GIF', 16),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Awesome GIF', 17),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Fantastic GIF', 18),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Unbelievable GIF', 19),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Outstanding GIF', 20)
...
FROM sticker_packs sp
CROSS JOIN (VALUES
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Party Popper GIF', 1),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Confetti GIF', 2),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Celebration GIF', 3),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Birthday GIF', 4),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Congratulations GIF', 5),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Cheers GIF', 6),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Victory GIF', 7),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Success GIF', 8),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Win GIF', 9),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Achievement GIF', 10),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Milestone GIF', 11),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Anniversary GIF', 12),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'New Year GIF', 13),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Holiday GIF', 14),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Festival GIF', 15),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Carnival GIF', 16),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Parade GIF', 17),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Fireworks GIF', 18),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Sparkles GIF', 19),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Magic GIF', 20)
) AS emoji(gif_url, name, order_num)
...
FROM sticker_packs sp
CROSS JOIN (VALUES
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Laughing GIF', 1),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Crying GIF', 2),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Love GIF', 3),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Heart Eyes GIF', 4),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Kiss GIF', 5),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Hug GIF', 6),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Angry GIF', 7),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Sad GIF', 8),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Happy GIF', 9),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Excited GIF', 10),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Surprised GIF', 11),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Shocked GIF', 12),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Confused GIF', 13),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Thinking GIF', 14),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Sleepy GIF', 15),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Tired GIF', 16),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Energetic GIF', 17),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Proud GIF', 18),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Shy GIF', 19),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Blushing GIF', 20)
) AS emoji(gif_url, name, order_num)
...
FROM sticker_packs sp
CROSS JOIN (VALUES
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Cute Cat GIF', 1),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Cute Dog GIF', 2),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Dancing GIF', 3),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Waving GIF', 4),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Jumping GIF', 5),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Spinning GIF', 6),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Bouncing GIF', 7),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Winking GIF', 8),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Blowing Kiss GIF', 9),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'High Five GIF', 10),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Fist Bump GIF', 11),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Peace Sign GIF', 12),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Rock On GIF', 13),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'OK Sign GIF', 14),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Pointing GIF', 15),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Shrugging GIF', 16),
  ('https://media.giphy.com/media/3o7aCT8j7tX3xMxGqk/giphy.gif', 'Face Palm GIF', 17),
  ('https://media.giphy.com/media/3o7abldet0lRBPfTP6/giphy.gif', 'Eye Roll GIF', 18),
  ('https://media.giphy.com/media/3o7aD2saal8x2vn7zi/giphy.gif', 'Smirk GIF', 19),
  ('https://media.giphy.com/media/3o7aCTPPm4OHfRLSH6/giphy.gif', 'Cool GIF', 20)
) AS emoji(gif_url, name, order_num)
